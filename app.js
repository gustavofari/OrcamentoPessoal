...
function cadastrarDespesa() {
	...
	if (despesas.validarCadastro()){
		bd.gravar(despesas)

		document.getElementById('modalHeader').innerHTML = 'Registro inserido com sucesso'
		...
		document.getElementById('modalHeader').innerHTML = 'Erro na inclusão do registro'
